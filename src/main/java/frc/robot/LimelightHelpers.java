...
public class LimelightHelpers {
    ...
    //https://github.com/LimelightVision/limelightlib-wpijava/blob/main/LimelightHelpers.java#L9 

    //to use the getters, write for example, LimelightHelpers.getTX(detector) or LimelightHelpers.getPose3d(tags) with detector and tags as the 2 limelight names/parameters
