...
public class AutoPivotAndRevShooter extends ParallelCommandGroup {
  /** Creates a new AutoPivotAndRevShooter. */
  public AutoPivotAndRevShooter(PivotSubsystem pivot, IntakeSubsystem intake, BlinkinLED LED) {
