...
public class PivotToAngleAndShoot extends SequentialCommandGroup {
   ...
   */
  public PivotToAngleAndShoot(double desiredAngle, double intakeRPS, double beltSpeed, PivotSubsystem pivot, IntakeSubsystem intake, BlinkinLED blinkin, OI oi, double shootTime, boolean considerGravity, double pivotTolerance) {
